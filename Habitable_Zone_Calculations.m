...
title(append(s.Name,' Habitable Zone Boundaries'));
circle(0,0,s.HZ(1),'#FF0000');
circle(0,0,s.HZ(2),'#EDB120');
circle(0,0,s.HZ(3),'#77AC30');
circle(0,0,s.HZ(4),'#0072BD');
text(s.HZ(1)-0.025,0.15,'Recent Venus','Color','#FF0000','FontSize',10,'HorizontalAlignment','right');
text(s.HZ(2),0.25,'Runaway Greenhouse','Color','#EDB120','FontSize',10);
text(s.HZ(3)-0.025,0.15,'Maximum Greenhouse','Color','#77AC30','FontSize',10,'HorizontalAlignment','right');
text(s.HZ(4),0.25,'Early Mars','Color','#0072BD','FontSize',10);
text(0,0.1,s.Name);
