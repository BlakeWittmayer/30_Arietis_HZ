...
if s.Name == '30 Arietis Ba'
    a = 0.967;
    plot(a,0,'.',Color='#BF40BF',MarkerSize=40); % 30 Ari Bb
    text(1.1,-0.15,'30 Arietis Bb',HorizontalAlignment='right',FontSize=20, ...
        FontName='times');
...
text(s.HZ(4),0.25,'Early Mars',Color='#0072BD',FontSize=15, ...
    FontName='times');
text(0,0.1,s.Name,FontSize=20,FontName='times', ...
